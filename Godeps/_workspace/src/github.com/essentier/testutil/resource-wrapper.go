...
func (rw *resWrapper) Get(responseBody interface{}) {
...
func (rw *resWrapper) Put(payload interface{}, responseBody interface{}) {
	rw.Resource.Response = responseBody
...
// Accepts interface{} as parameter, will be used as payload.
func (rw *resWrapper) Post(payload interface{}, responseBody interface{}) {
	rw.Resource.Response = responseBody
...
func (rw *resWrapper) Delete(responseBody interface{}) {
	rw.Resource.Response = responseBody
...
func (rw *resWrapper) Options(responseBody interface{}) {
	rw.Resource.Response = responseBody
...
// Accepts interface{} as parameter, will be used as payload.
func (rw *resWrapper) Patch(payload interface{}, responseBody interface{}) {
	rw.Resource.Response = responseBody
